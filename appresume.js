...
// Function to download the resume as myresume.html
function downloadResume() {
    ...
    // Generate the full HTML for the file (standalone page)
    const fullHTML = `
        <!DOCTYPE html>
        <html lang="en">
        <head>
...
// Function to view the resume in a modal
function viewResume() {
    const resumeData = JSON.parse(localStorage.getItem('resumeData'));
    if (!resumeData) {
...
// Function to edit the resume (load data back into form)
function editResume() {
    const resumeData = JSON.parse(localStorage.getItem('resumeData'));
    if (!resumeData) {
